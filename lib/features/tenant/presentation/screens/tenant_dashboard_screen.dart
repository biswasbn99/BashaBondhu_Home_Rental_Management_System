                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${l10n.localeName == 'bn' ? 'বাজেট' : 'Budget'}: ${demand.budgetRange ?? '0'} ৳",
                              style: const TextStyle(
                                fontSize: 12.5,
                                fontWeight: FontWeight.bold,
                                color: AppColors.themeColor,
      ...
      child: Column(
        children: [
          ...
          _buildTimelineTile(
            ...
            title: isVerified ? (l10n.localeName == 'bn' ? 'এনআইডি ভেরিফাইড ভাড়াটিয়া' : 'NID Verified Tenant') : (l10n.localeName == 'bn' ? 'এনআইডি ভেরিফিকেশন পেন্ডিং' : 'NID Verification Pending'),
            subtitle: isVerified
