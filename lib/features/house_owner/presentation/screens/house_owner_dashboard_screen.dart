                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        isVerified ? (l10n.localeName == 'bn' ? 'এনআইডি যাচাইকৃত' : 'NID Verified') : (l10n.localeName == 'bn' ? 'এনআইডি পেন্ডিং' : 'NID Pending'),
                        style: TextStyle(
                          fontSize: 9.5,
                          fontWeight: FontWeight.bold,
    ...
    return GridView.count(
      ...
      children: [
        ...
        _buildMetricCard(
          ...
          label: l10n.localeName == 'bn' ? 'ভেরিফিকেশন স্ট্যাটাস' : 'Verification Status',
          isDark: isDark,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 4),
                        Text(
                          "${property.amount} ৳ / ${l10n.localeName == 'bn' ? 'মাস' : 'month'}",
                          style: const TextStyle(
                            fontSize: 13,
                            fontWeight: FontWeight.bold,
                            color: AppColors.themeColor,
              ...
              Row(
                ...
                children: [
                  TextButton.icon(
                    ...
                    label: Text(l10n.localeName == 'bn' ? 'দেখুন' : 'View', style: const TextStyle(fontSize: 12)),
                  ),
                  TextButton.icon(
                    onPressed: () {
                    ...
                    label: Text(l10n.localeName == 'bn' ? 'এডিট' : 'Edit', style: const TextStyle(fontSize: 12)),
                  ),
                  TextButton.icon(
                    onPressed: () => _showDeleteConfirmDialog(context, property.id, propertyService, l10n),
                    icon: const Icon(Icons.delete_outline_rounded, size: 16, color: Colors.redAccent),
                    label: Text(l10n.localeName == 'bn' ? 'মুছুন' : 'Delete', style: const TextStyle(fontSize: 12, color: Colors.redAccent)),
                  ),
                ],
              ),
            ],
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            "${demand.area.name}, ${demand.district.name} • ${l10n.localeName == 'bn' ? 'বাজেট' : 'Budget'}: ${demand.budgetRange ?? '0'} ৳",
                            style: TextStyle(fontSize: 12, color: isDark ? Colors.grey[400] : _grey),
                          ),
                        ],
                      ),
      ...
      child: Column(
        children: [
          _buildTimelineTile(
            ...
            subtitle: '${l10n.localeName == 'bn' ? 'যোগদান করেছেন' : 'Joined'}: ${_formatTimestamp(user.createdAt)}',
            isLast: false,
          ),
          _buildTimelineTile(
          ...
          _buildTimelineTile(
            ...
            title: isVerified ? (l10n.localeName == 'bn' ? 'এনআইডি ভেরিফাইড হোস্ট' : 'NID Verified Host') : (l10n.localeName == 'bn' ? 'এনআইডি ভেরিফিকেশন পেন্ডিং' : 'NID Verification Pending'),
            subtitle: isVerified
